...
class Utils_JsonEncoder
{
     ...
     * @param $value object
     * @return string
     * @throws ZOL_Exception If recursive checks are enabled and the object has been serialized previously
     */
    ...
    public static function encodeClass($className, $package = '')
    {
        ...
        if (! $cls->isInstantiable()) {
            require_once 'Zend/Json/Exception.php';
            throw new ZOL_Exception("$className must be instantiable");
        }
